...
- (void)viewDidLoad {
    ...
    button1.imageView.image = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:@"https://gw.alicdn.com/tps/TB1W_X6OXXXXXcZXVXXXXXXXXXX-400-400.png"]]];

//     button1.imageView.image = [UIImage imageNamed:@"menu_circle_64"];
